...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.lambda_strand_temporal_smooth = 0.0  # A: penalize frame-to-frame change in strand offsets
        self.threshold_strand_temporal_smooth = 0.0
        self.lambda_strand_temporal_gate_l2 = 0.0  # optional regularizer on learned temporal gates
